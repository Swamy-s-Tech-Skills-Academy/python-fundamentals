---
learning_level: "Service Builder → Systems Crafter"
level_number: 17
...
outcome: "2 Mini Projects: hardened service and containerized observable mini stack"
transformation_focus: "Run Python services with production-like configuration, health checks, and observability."
...
learning_objectives:
  - "Complete Phase A sessions and Mini Project 1 for Level 17"
  - "Complete Phase B sessions and Mini Project 2 for Level 17"
  - "Meet Level 17 exit criteria before advancing"
related_topics:
  prerequisites:
    - "docs/sessions/L16/_Plan.md"
  builds_upon:
    - "docs/sessions/L16/_Plan.md"
  enables:
    - "docs/sessions/L18/_Plan.md"
  cross_refs:
    - "docs/01_Python-Fundamentals-MasterPlan.md"
sessions:
  - session: 1
    topic: "Service Hardening 101: Failure Modes, Timeouts & Retries"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L17/S1.md"
  - session: 2
    topic: "Structured Logging & Log Levels for Services"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L17/S2.md"
  - session: 3
    topic: "Configuration Management: Env Vars, Config Files & 12-Factor Basics"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L17/S3.md"
  - session: 4
    topic: "Health Checks & Basic Metrics (Counters, Timers, Gauges)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
  ...
  - session: "5 (MP 1)"
    ...
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L17/S5.md"
  - session: 6
    topic: "Docker for Python Services: Writing a Simple, Production-Friendly Dockerfile"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L17/S6.md"
  - session: 7
    topic: "Docker Compose: Running Service + DB/Redis/RabbitMQ Together Locally"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L17/S7.md"
  - session: 8
    topic: "Observability in Containers: Logs, Metrics & Simple Dashboards"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L17/S8.md"
  - session: 9
    topic: "Production-Like Environments: Resource Limits, Readiness & Rollout Basics"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
...
```mermaid
flowchart TB
  A["🎯 Service Builder"] --> PhaseA
  PhaseA --> PhaseB
  PhaseB --> K["🎓 Systems Crafter"]

  subgraph PhaseA["📘 Phase A: Hardening & Observability Basics"]
    B1["Session 1"]
    B2["Session 2"]
    B3["Session 3"]
    B4["Session 4"]
    B5["Session 5 (MP 1)<br>Hardened Service"]
    B1 --> B2 --> B3 --> B4 --> B5
  end

  subgraph PhaseB["📘 Phase B: Docker & Production-Like Ops"]
    C1["Session 6"]
    C2["Session 7"]
    C3["Session 8"]
    C4["Session 9"]
    C5["Session 10 (MP 2)<br>Containerized Stack"]
    C1 --> C2 --> C3 --> C4 --> C5
  end
