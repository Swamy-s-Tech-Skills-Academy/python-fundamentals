---
learning_level: "Integration Novice → Practitioner"
level_number: 8
...
outcome: "2 Mini Projects: CLI wrapper and polished portfolio-ready CLI tool"
transformation_focus: "Structure, test, version-control, and polish small Python projects like real tools."
curriculum_status: "Draft"
delivery_status: "All sessions pending (see docs/meetup/L8/sessions.md)"
...
learning_objectives:
  - "Complete Phase A sessions and Mini Project 1 for Level 8"
  - "Complete Phase B sessions and Mini Project 2 for Level 8"
  - "Meet Level 8 exit criteria before advancing"
related_topics:
  prerequisites:
    - "docs/sessions/L7/_Plan.md"
  builds_upon:
  ...
  cross_refs:
    ...
    - "docs/meetup/L8/sessions.md"
sessions:
  - session: 1
    topic: "Practical KISS/DRY/YAGNI on Real Code"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L8/S1.md"
  - session: 2
    topic: "Building User-Friendly CLIs (argparse / click Intro)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L8/S2.md"
  - session: 3
    topic: "Structuring Projects: Folders, Modules, and Entry Points"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L8/S3.md"
  - session: 4
    topic: "Git Basics: Commits, Branches, and Clean Histories"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
  ...
  - session: "5 (MP 1)"
    ...
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L8/S5.md"
  - session: 6
    topic: "Everyday Testing with pytest / unittest (No TDD Dogma)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L8/S6.md"
  - session: 7
    topic: "AI as Pair Programmer: Prompting for Refactoring & Code Review"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L8/S7.md"
  - session: 8
    topic: "Formatting & Linting (black, isort, flake8 – Concept Intro)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L8/S8.md"
  - session: 9
    topic: "Polishing a Small Project: From Script to Mini Product"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
...
```mermaid
flowchart TB
  A["🎯 Integration Novice"] --> PhaseA
  PhaseA --> PhaseB
  PhaseB --> K["🎓 Practitioner"]

  subgraph PhaseA["📘 Phase A: Clean Code & CLI Foundations"]
    B1["Session 1"]
    B2["Session 2"]
    B3["Session 3"]
    B4["Session 4"]
    B5["Session 5 (MP 1)<br>CLI Wrapper"]
    B1 --> B2 --> B3 --> B4 --> B5
  end

  subgraph PhaseB["📘 Phase B: Testing, AI Pairing & Polish"]
    C1["Session 6"]
    C2["Session 7"]
    C3["Session 8"]
    C4["Session 9"]
    C5["Session 10 (MP 2)<br>Polished CLI Tool"]
    C1 --> C2 --> C3 --> C4 --> C5
  end
