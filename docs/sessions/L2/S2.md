...
- ✅ Understand what list comprehensions are and why they're elegant
- ✅ Write basic list comprehensions with expressions
- ✅ Add conditions to filter data
- ✅ Know when to use comprehensions vs traditional loops
- ✅ Transform lists, sets, and other iterables
...
✅ Understand lists and loops from [Level 1 Session 7](../L1/08_S7.md)  
✅ Comfortable with `for` loops and `if` statements  
✅ Know how to work with lists and sets

---

## 💻 **Part 1: What Are List Comprehensions?**
...
## 💻 **Part 4: Comprehensions vs Loops**

### **When to Use List Comprehensions**

**Use comprehensions when:**

- ✅ Creating a new list from existing data
...
- ✅ You need side effects (printing, file operations)
- ✅ Multiple operations per iteration
- ✅ Code would be too long or confusing as a comprehension
...
- [Session 3: Functions: Definition & Basics](03_S3.md) - Create reusable code
- [Mini Project 1: Data Processor](05_MP1.md) - Use comprehensions in a project
