---
learning_level: "Systems Crafter → Curious Professional"
level_number: 18
...
outcome: "2 Mini Projects: capstone MVP and v1.0 portfolio release"
transformation_focus: "Consolidate the full journey into one realistic, documented, tested system."
...
sessions:
  - session: 1
    topic: "Choosing & Scoping Your Capstone (Domain, Users, Success Criteria)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S1.md"
  - session: 2
    topic: "Writing a Lightweight Design Doc (Architecture, Data, Interfaces)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S2.md"
  - session: 3
    topic: "Integrating Building Blocks: DB, Caching, Messaging & HTTP APIs"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S3.md"
  - session: 4
    topic: "Capstone Implementation Sprint 1 (Core Functionality)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S4.md"
  - session: "5 (MP 1)"
    topic: "Mini Project 1: Capstone MVP (End-to-End Happy Path Working)"
    duration: "30–45 min"
    type: "Project"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S5.md"
  - session: 6
    topic: "Docs & Developer Experience: README, API Docs & Quickstart"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S6.md"
  - session: 7
    topic: "CI/CD Basics: Automated Tests, Linting & Simple Deployment Pipeline (e.g. GitHub Actions)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S7.md"
  - session: 8
    topic: "Polishing & Refactoring: Code Quality Pass, Logging/Metrics Review, Packaging for Reuse"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S8.md"
  - session: 9
    topic: "Storytelling & Next Steps: Writing a Portfolio Case Study & Future Learning Roadmap"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S9.md"
  - session: "10 (MP 2)"
    topic: "Mini Project 2: Capstone v1.0 Release (Tagged, Documented & Showcased in Portfolio)"
    duration: "30–45 min"
    type: "Project"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L18/S10.md"
---
...
| A | 5 (MP 1) | Mini Project 1: Capstone MVP (End-to-End Happy Path Working) *(after Session 4)* | 30–45 min | 🛠️ Project | Draft | Pending |
...
| B | 10 (MP 2) | Mini Project 2: Capstone v1.0 Release (Tagged, Documented & Showcased in Portfolio) *(after Session 9)* | 30–45 min | 🛠️ Project | Draft | Pending |
...
```mermaid
flowchart TB
  A["🎯 Systems Crafter"] --> PhaseA
  PhaseA --> PhaseB
  PhaseB --> K["🎓 Curious Professional"]

  subgraph PhaseA["📘 Phase A: Capstone Design & MVP"]
    B1["Session 1"]
    B2["Session 2"]
    B3["Session 3"]
    B4["Session 4"]
    B5["Session 5 (MP 1)<br>Capstone MVP"]
    B1 --> B2 --> B3 --> B4 --> B5
  end

  subgraph PhaseB["📘 Phase B: Docs, CI/CD & Portfolio"]
    C1["Session 6"]
    C2["Session 7"]
    C3["Session 8"]
    C4["Session 9"]
    C5["Session 10 (MP 2)<br>Capstone v1.0 Release"]
    C1 --> C2 --> C3 --> C4 --> C5
  end
