---
learning_level: "Design Learner → Data Wrangler"
level_number: 5
stage_part: "Part 1 — Python Fundamentals"
prerequisites:
  - "docs/sessions/L4/_Plan.md"
total_duration: "~5 hours core guided instruction (+ MPs)"
format: "2 phases × (4 sessions + 1 mini project) = 10 sessions total"
outcome: "2 Mini Projects for CSV/JSON cleaning and file-based reporting"
transformation_focus: "Read, clean, transform, and write text, CSV, and JSON data confidently."
curriculum_status: "Draft"
delivery_status: "All sessions pending (see docs/meetup/L5/sessions.md)"
...
learning_objectives:
  - "Complete Phase A sessions and Mini Project 1 for Level 5"
  - "Complete Phase B sessions and Mini Project 2 for Level 5"
  - "Meet Level 5 exit criteria before advancing"
related_topics:
  prerequisites:
    - "docs/sessions/L4/_Plan.md"
  builds_upon:
  ...
  cross_refs:
    ...
    - "docs/meetup/L5/sessions.md"
sessions:
  - session: 1
    topic: "Reviewing File I/O: Text vs Binary, Paths, Encodings"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L5/S1.md"
  - session: 2
    topic: "CSV Basics: Reading & Writing Tabular Data"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L5/S2.md"
  - session: 3
    topic: "JSON Basics: Nested Structures & Config-Style Data"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L5/S3.md"
  - session: 4
    topic: "From Raw Text to Structured Data (Parsing & Cleaning)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
  ...
  - session: "5 (MP 1)"
    ...
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L5/S5.md"
  - session: 6
    topic: "Building Simple Data Pipelines (Read → Transform → Write)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L5/S6.md"
  - session: 7
    topic: "Basic Serialization & Settings Files (Configs & States)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L5/S7.md"
  - session: 8
    topic: "Robust File Handling: Errors, Missing Data & Validation"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L5/S8.md"
  - session: 9
    topic: "End-to-End File-Based Mini App (Putting It All Together)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
...
```mermaid
flowchart TB
  A["🎯 Design Learner"] --> PhaseA
  PhaseA --> PhaseB
  PhaseB --> K["🎓 Data Wrangler"]

  subgraph PhaseA["📘 Phase A: File I/O & Structured Formats"]
    B1["Session 1"]
    B2["Session 2"]
    B3["Session 3"]
    B4["Session 4"]
    B5["Session 5 (MP 1)<br>Data Cleaner"]
    B1 --> B2 --> B3 --> B4 --> B5
  end

  subgraph PhaseB["📘 Phase B: Pipelines & File-Based Apps"]
    C1["Session 6"]
    C2["Session 7"]
    C3["Session 8"]
    C4["Session 9"]
    C5["Session 10 (MP 2)<br>Data Dashboard"]
    C1 --> C2 --> C3 --> C4 --> C5
  end
