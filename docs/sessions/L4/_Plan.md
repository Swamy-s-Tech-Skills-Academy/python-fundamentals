---
learning_level: "Object Thinker → Design Learner"
level_number: 4
...
outcome: "2 Mini Projects applying design, refactoring, and first unit tests"
transformation_focus: "Move from working classes to intentional design, refactoring, and testable OOP."
curriculum_status: "Draft"
delivery_status: "All sessions pending (see docs/meetup/L4/sessions.md)"
...
learning_objectives:
  - "Complete Phase A sessions and Mini Project 1 for Level 4"
  - "Complete Phase B sessions and Mini Project 2 for Level 4"
  - "Meet Level 4 exit criteria before advancing"
related_topics:
  prerequisites:
    - "docs/sessions/L3/_Plan.md"
  builds_upon:
  ...
  cross_refs:
    ...
    - "docs/meetup/L4/sessions.md"
sessions:
  - session: 1
    topic: "From Requirements to Classes (Thinking in Models)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L4/S1.md"
  - session: 2
    topic: "Designing Responsibilities & Avoiding God Classes"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L4/S2.md"
  - session: 3
    topic: "Improving Class Interfaces (KISS for Methods & Classes)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L4/S3.md"
  - session: 4
    topic: "Intro to Refactoring: Making Existing Code Cleaner"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
  ...
  - session: "5 (MP 1)"
    ...
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L4/S5.md"
  - session: 6
    topic: "Clean Code Principles: KISS, DRY, YAGNI (Applied)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L4/S6.md"
  - session: 7
    topic: "Reading & Reviewing Code: Finding Smells in OOP Code"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L4/S7.md"
  - session: 8
    topic: "Intro Unit Tests for Classes (Arrange–Act–Assert)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
    file: "docs/sessions/L4/S8.md"
  - session: 9
    topic: "Organizing a Small OOP Project (Modules & Packages)"
    duration: "30 min"
    type: "Knowledge"
    curriculum: "Draft"
    delivery: "Pending"
...
```mermaid
flowchart TB
  A["🎯 Object Thinker"] --> PhaseA
  PhaseA --> PhaseB
  PhaseB --> K["🎓 Design Learner"]

  subgraph PhaseA["📘 Phase A: From Requirements to Refactoring"]
    B1["Session 1"]
    B2["Session 2"]
    B3["Session 3"]
    B4["Session 4"]
    B5["Session 5 (MP 1)<br>Refactor to Classes"]
    B1 --> B2 --> B3 --> B4 --> B5
  end

  subgraph PhaseB["📘 Phase B: Clean Code & Tested OOP"]
    C1["Session 6"]
    C2["Session 7"]
    C3["Session 8"]
    C4["Session 9"]
    C5["Session 10 (MP 2)<br>Clean OOP App"]
    C1 --> C2 --> C3 --> C4 --> C5
  end
