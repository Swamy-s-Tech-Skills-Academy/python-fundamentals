...
You are reviewing documentation in **python-fundamentals** (**Python fundamentals curriculum only**).
...
3. Flag copied or source-shaped text, mismatched paths vs `docs/RepositoryStructure.md`, missing reasoning, and examples that introduce concepts too early.
