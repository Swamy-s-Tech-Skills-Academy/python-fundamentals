...
1. For Markdown under the paths in `.github/workflows/docs-quality.yml`, the project uses **markdownlint** and **Lychee** (see `README.md` and `scripts/`).
2. Suggest the exact `scripts/docs-lint.ps1` and `scripts/docs-links.ps1` usage from the repo root, or the equivalent `npx`/Docker commands if documented.
